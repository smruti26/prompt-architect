...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ArchAI — AI Application Architect" },
      { name: "description", content: "Generate enterprise application architecture, diagrams, code and documentation from a single prompt or repository." },
      { name: "author", content: "ArchAI" },
